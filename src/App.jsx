...
<li className="flex flex-col items-center"> 
  ...
  <button class="bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 px-4 py-2 text-white rounded-full transition-all duration-200 ease-in-out transform hover:scale-105">Lamborghini</button>
</li>
<li className="flex flex-col items-center"> 
  ...
  <button class="bg-black hover:bg-black active:bg-black px-4 py-2 text-white rounded-full transition-all duration-200 ease-in-out transform hover:scale-105">Mercedes</button>
</li>
<li className="flex flex-col items-center"> 
  <img src="https://www.pngplay.com/wp-content/uploads/13/Renault-Logo-PNG-Photos.png" alt="" class="h-20 w-30 object-cover" />
  <button class="bg-red-500 hover:bg-red-600 active:bg-red-700 px-4 py-2 text-white rounded-full transition-all duration-200 ease-in-out transform hover:scale-105">Renault</button>
</li>
<li className="flex flex-col items-center"> 
  <img src="https://assets.stickpng.com/images/580b585b2edbce24c47b2c18.png" alt="" class="h-20 w-30 object-cover" />
  <button class="bg-gray-500 hover:bg-gray-600 active:bg-gray-700 px-4 py-2 text-white rounded-full transition-all duration-200 ease-in-out transform hover:scale-105">Audi</button>
</li>
<li className="flex flex-col items-center"> 
  <img src="https://www.pngplay.com/wp-content/uploads/13/BMW-Logo-PNG-Pic-Background.png" alt="" class="h-20 w-30 object-cover" />
  <button class="bg-blue-500 hover:bg-blue-600 active:bg-blue-700 px-4 py-2 text-white rounded-full transition-all duration-200 ease-in-out transform hover:scale-105">BMW</button>
</li>
</ul>
